...
use arrostd::syscall::{
    ...
    SYS_PIPE, SYS_PIPE2, SYS_READ, SYS_READLINK, SYS_RECV, SYS_RECVFROM, SYS_RENAME, SYS_RMDIR,
    SYS_SEEK, SYS_SEND, SYS_SENDTO, SYS_SIGACTION, SYS_SIGRETURN, SYS_SLEEP, SYS_SOCKET, SYS_SPAWN,
    SYS_SYMLINK, SYS_TIME_MS, SYS_UNLINK, SYS_WAITPID, SYS_WRITE, SYS_YIELD, TcpConnectReq,
