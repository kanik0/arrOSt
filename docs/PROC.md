...
- Scheduler now tracks KPTI scratch roots (`kernel_root_table`, `user_root_table`) during ring-3 address-space switch/restore as groundwork for trampoline entry/exit wiring.
