...
- Ring-3 page-table creation now preserves only upper-half root-table entries and maps a fixed trampoline page (`mem::TRAMPOLINE_VADDR`) as M11 groundwork; full kernel isolation still requires trampoline gate wiring and CR3/TTBR switching.
